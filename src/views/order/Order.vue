          ...
          <el-form label-position="top" label-width="80px">
            <el-form-item label="花型">
              <el-upload
                ...
                :data="{'type':0}"
                :auto-upload="true" :on-success="uploadSuccess" :file-list="fileList" :before-remove="doLogin">
            ...
            <el-form-item label="选择客户">
              <div class="chooseCustomer">
                ...
                <el-button type="info" plain @click="toCreateUser">创建新客户</el-button>
              </div>
            </el-form-item>
            ...
            <el-form-item label="面料">
              <div class="chooseF">
                <el-select v-model="fabricName" placeholder="请选择面料">
                  <el-option
            ...
            <el-form-item label="配置方案">
              <div class="chooseF">
                <el-select v-model="configName" placeholder="请选择配置方案">
                  <el-option
            ...
            <el-form-item label="花型路径">
              <el-input v-model="flowerPath"></el-input>
            </el-form-item>
            <el-form-item label="选择调色员">
              <div class="chooseCustomer">
                <el-select v-model="fkColorAccount" placeholder="请选择调色员">
                  <el-option
